...
export default function InstagramReelsSection() {
  ...
  useEffect(() => {
    if (isModalOpen && useRawHtmlEmbed && modalContentRef.current) {
      // Check if Instagram's script has loaded and process embeds
  ...
  return (
    <>
      ...
      <Dialog open={isModalOpen} onOpenChange={handleModalOpenChange}>
        <DialogContent 
            ref={modalContentRef}
            className="sm:max-w-[375px] p-0 overflow-hidden border-0" 
            // Apply aspect ratio only for iframe, blockquote handles its own sizing
