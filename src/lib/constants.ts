...
export const INSTAGRAM_REELS_DATA: InstagramReel[] = [
  {
    id: 'reel1',
    title: 'CodeCafe Lab: Genkit AI Demo',
    thumbnailUrl: 'https://placehold.co/270x480.png?text=CCL+Genkit+AI',
    instagramUrl: '#',
    dataAiHint: 'codecafelab instagram ai',
    duration: '0:58',
  },
  {
    id: 'reel2',
    title: 'Building UIs with ShadCN at CodeCafe Lab',
    thumbnailUrl: 'https://placehold.co/270x480.png?text=CCL+ShadCN+UI',
    instagramUrl: '#',
    instagramUrl: '#',
    dataAiHint: 'codecafelab instagram design',
    duration: '0:42',
  },
  {
    id: 'reel3',
    title: 'Inside CodeCafe: Our Team Culture',
    thumbnailUrl: 'https://placehold.co/270x480.png?text=CCL+Team+Culture',
    instagramUrl: '#',
    dataAiHint: 'codecafelab instagram office',
    duration: '1:05',
  },
  {
    id: 'reel4',
    title: 'DevOps Magic: CI/CD at CodeCafe Lab',
    thumbnailUrl: 'https://placehold.co/270x480.png?text=CCL+CI/CD',
    instagramUrl: '#',
    dataAiHint: 'codecafelab instagram devops',
    duration: '0:50',
  },
  {
    id: 'reel5',
    title: 'Blockchain Explained: CodeCafe Lab Insights',
    thumbnailUrl: 'https://placehold.co/270x480.png?text=CCL+Blockchain',
    instagramUrl: '#',
    dataAiHint: 'codecafelab instagram crypto',
    duration: '0:48',
  },
  {
    id: 'reel6',
    title: 'CodeCafe UI Tip: Effective Color Palettes',
    thumbnailUrl: 'https://placehold.co/270x480.png?text=CCL+Color+Tip',
    instagramUrl: '#',
    dataAiHint: 'codecafelab instagram design',
    duration: '0:33',
  },
